 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.ObjectOneOfImpl#getNamedIndividual <em>Named Individual</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.ObjectOneOfImpl#getAnonymousIndividual <em>Anonymous Individual</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectOneOfImpl extends ClassExpressionImpl implements ObjectOneOf {
	...
	protected EClass eStaticClass() {
		return OWLModelPackage.eINSTANCE.getObjectOneOf();
	}
	...
	public EList<NamedIndividual> getNamedIndividual() {
		if (namedIndividual == null) {
			namedIndividual = new EObjectContainmentEList<NamedIndividual>(NamedIndividual.class, this, OWLModelPackage.OBJECT_ONE_OF__NAMED_INDIVIDUAL);
		}
	...
	public EList<AnonymousIndividual> getAnonymousIndividual() {
		if (anonymousIndividual == null) {
			anonymousIndividual = new EObjectContainmentEList<AnonymousIndividual>(AnonymousIndividual.class, this, OWLModelPackage.OBJECT_ONE_OF__ANONYMOUS_INDIVIDUAL);
		}

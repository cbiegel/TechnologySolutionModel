 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.SameIndividualImpl#getNamedIndividual <em>Named Individual</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.SameIndividualImpl#getAnonymousIndividual <em>Anonymous Individual</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SameIndividualImpl extends AssertionImpl implements SameIndividual {
	...
	protected EClass eStaticClass() {
		return OWLModelPackage.eINSTANCE.getSameIndividual();
	}
	...
	public EList<NamedIndividual> getNamedIndividual() {
		if (namedIndividual == null) {
			namedIndividual = new EObjectContainmentEList<NamedIndividual>(NamedIndividual.class, this, OWLModelPackage.SAME_INDIVIDUAL__NAMED_INDIVIDUAL);
		}
	...
	public EList<AnonymousIndividual> getAnonymousIndividual() {
		if (anonymousIndividual == null) {
			anonymousIndividual = new EObjectContainmentEList<AnonymousIndividual>(AnonymousIndividual.class, this, OWLModelPackage.SAME_INDIVIDUAL__ANONYMOUS_INDIVIDUAL);
		}

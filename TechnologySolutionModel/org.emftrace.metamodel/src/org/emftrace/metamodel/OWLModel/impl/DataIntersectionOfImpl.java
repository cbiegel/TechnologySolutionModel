 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.DataIntersectionOfImpl#getDatatype <em>Datatype</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.DataIntersectionOfImpl#getDataIntersectionOf <em>Data Intersection Of</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.DataIntersectionOfImpl#getDataUnionOf <em>Data Union Of</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.DataIntersectionOfImpl#getDataComplementOf <em>Data Complement Of</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.DataIntersectionOfImpl#getDataOneOf <em>Data One Of</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.DataIntersectionOfImpl#getDatatypeRestriction <em>Datatype Restriction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataIntersectionOfImpl extends DataRangeImpl implements DataIntersectionOf {
	...
	protected EClass eStaticClass() {
		return OWLModelPackage.eINSTANCE.getDataIntersectionOf();
	}
	...
	public EList<Datatype> getDatatype() {
		if (datatype == null) {
			datatype = new EObjectContainmentEList<Datatype>(Datatype.class, this, OWLModelPackage.DATA_INTERSECTION_OF__DATATYPE);
		}
		return datatype;
	}
	...
	public EList<DataIntersectionOf> getDataIntersectionOf() {
		if (dataIntersectionOf == null) {
			dataIntersectionOf = new EObjectContainmentEList<DataIntersectionOf>(DataIntersectionOf.class, this, OWLModelPackage.DATA_INTERSECTION_OF__DATA_INTERSECTION_OF);
		}
	...
	public EList<DataUnionOf> getDataUnionOf() {
		if (dataUnionOf == null) {
			dataUnionOf = new EObjectContainmentEList<DataUnionOf>(DataUnionOf.class, this, OWLModelPackage.DATA_INTERSECTION_OF__DATA_UNION_OF);
		}
		return dataUnionOf;
	}
	...
	public EList<DataComplementOf> getDataComplementOf() {
		if (dataComplementOf == null) {
			dataComplementOf = new EObjectContainmentEList<DataComplementOf>(DataComplementOf.class, this, OWLModelPackage.DATA_INTERSECTION_OF__DATA_COMPLEMENT_OF);
		}
	...
	public EList<DataOneOf> getDataOneOf() {
		if (dataOneOf == null) {
			dataOneOf = new EObjectContainmentEList<DataOneOf>(DataOneOf.class, this, OWLModelPackage.DATA_INTERSECTION_OF__DATA_ONE_OF);
		}
		return dataOneOf;
	}
	...
	public EList<DatatypeRestriction> getDatatypeRestriction() {
		if (datatypeRestriction == null) {
			datatypeRestriction = new EObjectContainmentEList<DatatypeRestriction>(DatatypeRestriction.class, this, OWLModelPackage.DATA_INTERSECTION_OF__DATATYPE_RESTRICTION);
		}

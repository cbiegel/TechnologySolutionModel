 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.AnnotationPropertyDomainImpl#getAnnotationProperty <em>Annotation Property</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.AnnotationPropertyDomainImpl#getIRI <em>IRI</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.AnnotationPropertyDomainImpl#getAbbreviatedIRI <em>Abbreviated IRI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationPropertyDomainImpl extends AnnotationAxiomImpl implements AnnotationPropertyDomain {
	...
	protected EClass eStaticClass() {
		return OWLModelPackage.eINSTANCE.getAnnotationPropertyDomain();
	}
	...
	public NotificationChain basicSetAnnotationProperty(AnnotationProperty newAnnotationProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__ANNOTATION_PROPERTY, oldAnnotationProperty, newAnnotationProperty);
	...
	public void setAnnotationProperty(AnnotationProperty newAnnotationProperty) {
		if (newAnnotationProperty != annotationProperty) {
			...
			if (annotationProperty != null)
				msgs = ((InternalEObject)annotationProperty).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__ANNOTATION_PROPERTY, null, msgs);
			if (newAnnotationProperty != null)
				msgs = ((InternalEObject)newAnnotationProperty).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__ANNOTATION_PROPERTY, null, msgs);
			msgs = basicSetAnnotationProperty(newAnnotationProperty, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__ANNOTATION_PROPERTY, newAnnotationProperty, newAnnotationProperty));
	}
	...
	public NotificationChain basicSetIRI(IRI newIRI, NotificationChain msgs) {
		...
		iri = newIRI;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__IRI, oldIRI, newIRI);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIRI(IRI newIRI) {
		if (newIRI != iri) {
			NotificationChain msgs = null;
			if (iri != null)
				msgs = ((InternalEObject)iri).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__IRI, null, msgs);
			if (newIRI != null)
				msgs = ((InternalEObject)newIRI).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__IRI, null, msgs);
			msgs = basicSetIRI(newIRI, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__IRI, newIRI, newIRI));
	}
	...
	public NotificationChain basicSetAbbreviatedIRI(AbbreviatedIRI newAbbreviatedIRI, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__ABBREVIATED_IRI, oldAbbreviatedIRI, newAbbreviatedIRI);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAbbreviatedIRI(AbbreviatedIRI newAbbreviatedIRI) {
		if (newAbbreviatedIRI != abbreviatedIRI) {
			...
			if (abbreviatedIRI != null)
				msgs = ((InternalEObject)abbreviatedIRI).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__ABBREVIATED_IRI, null, msgs);
			if (newAbbreviatedIRI != null)
				msgs = ((InternalEObject)newAbbreviatedIRI).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__ABBREVIATED_IRI, null, msgs);
			msgs = basicSetAbbreviatedIRI(newAbbreviatedIRI, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLModelPackage.ANNOTATION_PROPERTY_DOMAIN__ABBREVIATED_IRI, newAbbreviatedIRI, newAbbreviatedIRI));
	}

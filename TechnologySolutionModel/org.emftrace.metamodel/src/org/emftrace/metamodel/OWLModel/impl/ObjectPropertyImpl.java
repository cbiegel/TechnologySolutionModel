 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.ObjectPropertyImpl#getAbbreviatedIRI <em>Abbreviated IRI</em>}</li>
 *   <li>{@link org.emftrace.metamodel.OWLModel.impl.ObjectPropertyImpl#getIRI <em>IRI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectPropertyImpl extends ObjectPropertyExpressionImpl implements ObjectProperty {
	...
	protected EClass eStaticClass() {
		return OWLModelPackage.eINSTANCE.getObjectProperty();
	}
	...
	public void setAbbreviatedIRI(String newAbbreviatedIRI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLModelPackage.OBJECT_PROPERTY__ABBREVIATED_IRI, oldAbbreviatedIRI, abbreviatedIRI));
	}
	...
	public void setIRI(String newIRI) {
		...
		iri = newIRI;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLModelPackage.OBJECT_PROPERTY__IRI, oldIRI, iri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OWLModelPackage.OBJECT_PROPERTY__ABBREVIATED_IRI:
				return getAbbreviatedIRI();
			case OWLModelPackage.OBJECT_PROPERTY__IRI:
				return getIRI();
		}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.URNModel.impl.ConcreteURNspecImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.emftrace.metamodel.URNModel.impl.ConcreteURNspecImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.emftrace.metamodel.URNModel.impl.ConcreteURNspecImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.emftrace.metamodel.URNModel.impl.ConcreteURNspecImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link org.emftrace.metamodel.URNModel.impl.ConcreteURNspecImpl#getSpecVersion <em>Spec Version</em>}</li>
 *   <li>{@link org.emftrace.metamodel.URNModel.impl.ConcreteURNspecImpl#getUrnVersion <em>Urn Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConcreteURNspecImpl extends URNBaseImpl implements ConcreteURNspec {
	/**
	...
	protected EClass eStaticClass() {
		return URNModelPackage.Literals.CONCRETE_UR_NSPEC;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, URNModelPackage.CONCRETE_UR_NSPEC__DESCRIPTION, oldDescription, description));
	}
	...
	public void setAuthor(String newAuthor) {
		...
		author = newAuthor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, URNModelPackage.CONCRETE_UR_NSPEC__AUTHOR, oldAuthor, author));
	}
	...
	public void setCreated(String newCreated) {
		...
		created = newCreated;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, URNModelPackage.CONCRETE_UR_NSPEC__CREATED, oldCreated, created));
	}
	...
	public void setModified(String newModified) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, URNModelPackage.CONCRETE_UR_NSPEC__MODIFIED, oldModified, modified));
	}
	...
	public void setSpecVersion(String newSpecVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, URNModelPackage.CONCRETE_UR_NSPEC__SPEC_VERSION, oldSpecVersion, specVersion));
	}
	...
	public void setUrnVersion(String newUrnVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, URNModelPackage.CONCRETE_UR_NSPEC__URN_VERSION, oldUrnVersion, urnVersion));
	}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.JoinNodeImpl#isIsCombineDuplicate <em>Is Combine Duplicate</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.JoinNodeImpl#getJoinSpec <em>Join Spec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JoinNodeImpl extends ControlNodeImpl implements JoinNode {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getJoinNode();
	}
	...
	public void setIsCombineDuplicate(boolean newIsCombineDuplicate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.JOIN_NODE__IS_COMBINE_DUPLICATE, oldIsCombineDuplicate, isCombineDuplicate));
	}
	...
	public NotificationChain basicSetJoinSpec(ValueSpecification newJoinSpec, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UMLModelPackage.JOIN_NODE__JOIN_SPEC, oldJoinSpec, newJoinSpec);
	...
	public void setJoinSpec(ValueSpecification newJoinSpec) {
		if (newJoinSpec != joinSpec) {
			...
			if (joinSpec != null)
				msgs = ((InternalEObject)joinSpec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UMLModelPackage.JOIN_NODE__JOIN_SPEC, null, msgs);
			if (newJoinSpec != null)
				msgs = ((InternalEObject)newJoinSpec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLModelPackage.JOIN_NODE__JOIN_SPEC, null, msgs);
			msgs = basicSetJoinSpec(newJoinSpec, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.JOIN_NODE__JOIN_SPEC, newJoinSpec, newJoinSpec));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UMLModelPackage.JOIN_NODE__JOIN_SPEC:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.JOIN_NODE__IS_COMBINE_DUPLICATE:

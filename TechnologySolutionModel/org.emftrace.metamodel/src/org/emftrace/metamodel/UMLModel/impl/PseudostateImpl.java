 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.PseudostateImpl#getStateMachine <em>State Machine</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.PseudostateImpl#getState <em>State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PseudostateImpl extends VertexImpl implements Pseudostate {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getPseudostate();
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public void setStateMachine(String newStateMachine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.PSEUDOSTATE__STATE_MACHINE, oldStateMachine, stateMachine));
	}
	...
	public void setState(String newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.PSEUDOSTATE__STATE, oldState, state));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.PSEUDOSTATE__KIND:
				return getKind();
			case UMLModelPackage.PSEUDOSTATE__STATE_MACHINE:
				return getStateMachine();
			case UMLModelPackage.PSEUDOSTATE__STATE:
				return getState();
		}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.AssociationClassImpl#getRelatedElement <em>Related Element</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.AssociationClassImpl#getOwnedEnd <em>Owned End</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.AssociationClassImpl#isIsDerived <em>Is Derived</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.AssociationClassImpl#getNavigableOwnedEnd <em>Navigable Owned End</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.AssociationClassImpl#getMemberEnd <em>Member End</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.AssociationClassImpl#getEndType <em>End Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssociationClassImpl extends ClassImpl implements AssociationClass {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getAssociationClass();
	}
	...
	public void setRelatedElement(String newRelatedElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.ASSOCIATION_CLASS__RELATED_ELEMENT, oldRelatedElement, relatedElement));
	}
	...
	public EList<Property> getOwnedEnd() {
		if (ownedEnd == null) {
			ownedEnd = new EObjectContainmentEList<Property>(Property.class, this, UMLModelPackage.ASSOCIATION_CLASS__OWNED_END);
		}
		return ownedEnd;
	}
	...
	public void setIsDerived(boolean newIsDerived) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.ASSOCIATION_CLASS__IS_DERIVED, oldIsDerived, isDerived));
	}
	...
	public void setNavigableOwnedEnd(String newNavigableOwnedEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.ASSOCIATION_CLASS__NAVIGABLE_OWNED_END, oldNavigableOwnedEnd, navigableOwnedEnd));
	}
	...
	public void setMemberEnd(String newMemberEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.ASSOCIATION_CLASS__MEMBER_END, oldMemberEnd, memberEnd));
	}
	...
	public void setEndType(String newEndType) {
		...
		endType = newEndType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.ASSOCIATION_CLASS__END_TYPE, oldEndType, endType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UMLModelPackage.ASSOCIATION_CLASS__OWNED_END:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.ASSOCIATION_CLASS__RELATED_ELEMENT:
				return getRelatedElement();
			case UMLModelPackage.ASSOCIATION_CLASS__OWNED_END:
				return getOwnedEnd();
			case UMLModelPackage.ASSOCIATION_CLASS__IS_DERIVED:
				return isIsDerived();
			case UMLModelPackage.ASSOCIATION_CLASS__NAVIGABLE_OWNED_END:
				return getNavigableOwnedEnd();
			case UMLModelPackage.ASSOCIATION_CLASS__MEMBER_END:
				return getMemberEnd();
			case UMLModelPackage.ASSOCIATION_CLASS__END_TYPE:
				return getEndType();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Relationship.class) {
			switch (derivedFeatureID) {
				case UMLModelPackage.ASSOCIATION_CLASS__RELATED_ELEMENT: return UMLModelPackage.RELATIONSHIP__RELATED_ELEMENT;
				default: return -1;
			}
		}
		if (baseClass == Association.class) {
			switch (derivedFeatureID) {
				case UMLModelPackage.ASSOCIATION_CLASS__OWNED_END: return UMLModelPackage.ASSOCIATION__OWNED_END;
				case UMLModelPackage.ASSOCIATION_CLASS__IS_DERIVED: return UMLModelPackage.ASSOCIATION__IS_DERIVED;
				case UMLModelPackage.ASSOCIATION_CLASS__NAVIGABLE_OWNED_END: return UMLModelPackage.ASSOCIATION__NAVIGABLE_OWNED_END;
				case UMLModelPackage.ASSOCIATION_CLASS__MEMBER_END: return UMLModelPackage.ASSOCIATION__MEMBER_END;
				case UMLModelPackage.ASSOCIATION_CLASS__END_TYPE: return UMLModelPackage.ASSOCIATION__END_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Relationship.class) {
			switch (baseFeatureID) {
				case UMLModelPackage.RELATIONSHIP__RELATED_ELEMENT: return UMLModelPackage.ASSOCIATION_CLASS__RELATED_ELEMENT;
				default: return -1;
			}
		}
		if (baseClass == Association.class) {
			switch (baseFeatureID) {
				case UMLModelPackage.ASSOCIATION__OWNED_END: return UMLModelPackage.ASSOCIATION_CLASS__OWNED_END;
				case UMLModelPackage.ASSOCIATION__IS_DERIVED: return UMLModelPackage.ASSOCIATION_CLASS__IS_DERIVED;
				case UMLModelPackage.ASSOCIATION__NAVIGABLE_OWNED_END: return UMLModelPackage.ASSOCIATION_CLASS__NAVIGABLE_OWNED_END;
				case UMLModelPackage.ASSOCIATION__MEMBER_END: return UMLModelPackage.ASSOCIATION_CLASS__MEMBER_END;
				case UMLModelPackage.ASSOCIATION__END_TYPE: return UMLModelPackage.ASSOCIATION_CLASS__END_TYPE;
				default: return -1;
			}
		}

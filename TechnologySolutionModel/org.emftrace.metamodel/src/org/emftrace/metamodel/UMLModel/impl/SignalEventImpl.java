 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.SignalEventImpl#getSignal <em>Signal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignalEventImpl extends MessageEventImpl implements SignalEvent {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getSignalEvent();
	}
	...
	public void setSignal(String newSignal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.SIGNAL_EVENT__SIGNAL, oldSignal, signal));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.SIGNAL_EVENT__SIGNAL:
				return getSignal();
		}

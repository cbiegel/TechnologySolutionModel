 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ReceiveSignalEventImpl#getSignal <em>Signal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReceiveSignalEventImpl extends MessageEventImpl implements ReceiveSignalEvent {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getReceiveSignalEvent();
	}
	...
	public void setSignal(String newSignal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.RECEIVE_SIGNAL_EVENT__SIGNAL, oldSignal, signal));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.RECEIVE_SIGNAL_EVENT__SIGNAL:
				return getSignal();
		}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.AcceptEventActionImpl#isIsUnmarshall <em>Is Unmarshall</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.AcceptEventActionImpl#getResult <em>Result</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.AcceptEventActionImpl#getTrigger <em>Trigger</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AcceptEventActionImpl extends ActionImpl implements AcceptEventAction {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getAcceptEventAction();
	}
	...
	public void setIsUnmarshall(boolean newIsUnmarshall) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.ACCEPT_EVENT_ACTION__IS_UNMARSHALL, oldIsUnmarshall, isUnmarshall));
	}
	...
	public EList<OutputPin> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, UMLModelPackage.ACCEPT_EVENT_ACTION__RESULT);
		}
		return result;
	}
	...
	public EList<Trigger> getTrigger() {
		if (trigger == null) {
			trigger = new EObjectContainmentEList<Trigger>(Trigger.class, this, UMLModelPackage.ACCEPT_EVENT_ACTION__TRIGGER);
		}
		return trigger;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UMLModelPackage.ACCEPT_EVENT_ACTION__RESULT:
				return ((InternalEList<?>)getResult()).basicRemove(otherEnd, msgs);
			case UMLModelPackage.ACCEPT_EVENT_ACTION__TRIGGER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.ACCEPT_EVENT_ACTION__IS_UNMARSHALL:

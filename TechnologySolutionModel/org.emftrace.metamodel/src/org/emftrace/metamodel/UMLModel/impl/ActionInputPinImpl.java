 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ActionInputPinImpl#getFromAction <em>From Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionInputPinImpl extends InputPinImpl implements ActionInputPin {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getActionInputPin();
	}
	...
	public NotificationChain basicSetFromAction(Action newFromAction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UMLModelPackage.ACTION_INPUT_PIN__FROM_ACTION, oldFromAction, newFromAction);
	...
	public void setFromAction(Action newFromAction) {
		if (newFromAction != fromAction) {
			...
			if (fromAction != null)
				msgs = ((InternalEObject)fromAction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UMLModelPackage.ACTION_INPUT_PIN__FROM_ACTION, null, msgs);
			if (newFromAction != null)
				msgs = ((InternalEObject)newFromAction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLModelPackage.ACTION_INPUT_PIN__FROM_ACTION, null, msgs);
			msgs = basicSetFromAction(newFromAction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.ACTION_INPUT_PIN__FROM_ACTION, newFromAction, newFromAction));
	}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.TimeConstraintImpl#isFirstEvent <em>First Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeConstraintImpl extends IntervalConstraintImpl implements TimeConstraint {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getTimeConstraint();
	}
	...
	public void setFirstEvent(boolean newFirstEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.TIME_CONSTRAINT__FIRST_EVENT, oldFirstEvent, firstEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.TIME_CONSTRAINT__FIRST_EVENT:
				return isFirstEvent();
		}

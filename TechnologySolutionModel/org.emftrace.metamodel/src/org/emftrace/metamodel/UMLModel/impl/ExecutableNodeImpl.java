 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ExecutableNodeImpl#getHandler <em>Handler</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ExecutableNodeImpl extends ActivityNodeImpl implements ExecutableNode {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getExecutableNode();
	}
	...
	public EList<ExceptionHandler> getHandler() {
		if (handler == null) {
			handler = new EObjectContainmentEList<ExceptionHandler>(ExceptionHandler.class, this, UMLModelPackage.EXECUTABLE_NODE__HANDLER);
		}
		return handler;
	}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.OpaqueBehaviorImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.OpaqueBehaviorImpl#getLanguage <em>Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OpaqueBehaviorImpl extends BehaviorImpl implements OpaqueBehavior {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getOpaqueBehavior();
	}
	...
	public EList<String> getBody() {
		if (body == null) {
			body = new EDataTypeEList.Unsettable<String>(String.class, this, UMLModelPackage.OPAQUE_BEHAVIOR__BODY);
		}
		return body;
	}
	...
	public EList<String> getLanguage() {
		if (language == null) {
			language = new EDataTypeUniqueEList.Unsettable<String>(String.class, this, UMLModelPackage.OPAQUE_BEHAVIOR__LANGUAGE);
		}
		return language;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.OPAQUE_BEHAVIOR__BODY:
				return getBody();
			case UMLModelPackage.OPAQUE_BEHAVIOR__LANGUAGE:
				return getLanguage();
		}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ModelImpl#getViewpoint <em>Viewpoint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends PackageImpl implements Model {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getModel();
	}
	...
	public void setViewpoint(String newViewpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.MODEL__VIEWPOINT, oldViewpoint, viewpoint, !oldViewpointESet));
	}
	...
	public void unsetViewpoint() {
		...
		viewpointESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, UMLModelPackage.MODEL__VIEWPOINT, oldViewpoint, VIEWPOINT_EDEFAULT, oldViewpointESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.MODEL__VIEWPOINT:
				return getViewpoint();
		}

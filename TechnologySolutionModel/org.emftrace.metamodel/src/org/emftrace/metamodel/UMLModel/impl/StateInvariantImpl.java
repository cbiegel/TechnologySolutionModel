 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.StateInvariantImpl#getInvariant <em>Invariant</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateInvariantImpl extends InteractionFragmentImpl implements StateInvariant {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getStateInvariant();
	}
	...
	public NotificationChain basicSetInvariant(Constraint newInvariant, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UMLModelPackage.STATE_INVARIANT__INVARIANT, oldInvariant, newInvariant);
	...
	public void setInvariant(Constraint newInvariant) {
		if (newInvariant != invariant) {
			...
			if (invariant != null)
				msgs = ((InternalEObject)invariant).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UMLModelPackage.STATE_INVARIANT__INVARIANT, null, msgs);
			if (newInvariant != null)
				msgs = ((InternalEObject)newInvariant).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLModelPackage.STATE_INVARIANT__INVARIANT, null, msgs);
			msgs = basicSetInvariant(newInvariant, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.STATE_INVARIANT__INVARIANT, newInvariant, newInvariant));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UMLModelPackage.STATE_INVARIANT__INVARIANT:

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ProtocolStateMachineImpl#getConformance <em>Conformance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProtocolStateMachineImpl extends StateMachineImpl implements ProtocolStateMachine {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getProtocolStateMachine();
	}
	...
	public EList<ProtocolConformance> getConformance() {
		if (conformance == null) {
			conformance = new EObjectContainmentEList<ProtocolConformance>(ProtocolConformance.class, this, UMLModelPackage.PROTOCOL_STATE_MACHINE__CONFORMANCE);
		}
		return conformance;
	}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ConditionalNodeImpl#isIsDeterminate <em>Is Determinate</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ConditionalNodeImpl#isIsAssured <em>Is Assured</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ConditionalNodeImpl#getClause <em>Clause</em>}</li>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ConditionalNodeImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalNodeImpl extends StructuredActivityNodeImpl implements ConditionalNode {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getConditionalNode();
	}
	...
	public void setIsDeterminate(boolean newIsDeterminate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.CONDITIONAL_NODE__IS_DETERMINATE, oldIsDeterminate, isDeterminate));
	}
	...
	public void setIsAssured(boolean newIsAssured) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.CONDITIONAL_NODE__IS_ASSURED, oldIsAssured, isAssured));
	}
	...
	public EList<Clause> getClause() {
		if (clause == null) {
			clause = new EObjectContainmentEList<Clause>(Clause.class, this, UMLModelPackage.CONDITIONAL_NODE__CLAUSE);
		}
		return clause;
	}
	...
	public EList<OutputPin> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, UMLModelPackage.CONDITIONAL_NODE__RESULT);
		}
		return result;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UMLModelPackage.CONDITIONAL_NODE__CLAUSE:
				return ((InternalEList<?>)getClause()).basicRemove(otherEnd, msgs);
			case UMLModelPackage.CONDITIONAL_NODE__RESULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.CONDITIONAL_NODE__IS_DETERMINATE:
				return isIsDeterminate();
			case UMLModelPackage.CONDITIONAL_NODE__IS_ASSURED:
				return isIsAssured();
			case UMLModelPackage.CONDITIONAL_NODE__CLAUSE:
				return getClause();
			case UMLModelPackage.CONDITIONAL_NODE__RESULT:

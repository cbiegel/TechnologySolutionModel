 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.EnumerationImpl#getOwnedLiteral <em>Owned Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationImpl extends DataTypeImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getEnumeration();
	}
	...
	public EList<EnumerationLiteral> getOwnedLiteral() {
		if (ownedLiteral == null) {
			ownedLiteral = new EObjectContainmentEList<EnumerationLiteral>(EnumerationLiteral.class, this, UMLModelPackage.ENUMERATION__OWNED_LITERAL);
		}
		return ownedLiteral;
	}

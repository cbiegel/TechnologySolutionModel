 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.UMLModel.impl.ContinuationImpl#isSetting <em>Setting</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContinuationImpl extends InteractionFragmentImpl implements Continuation {
	...
	protected EClass eStaticClass() {
		return UMLModelPackage.eINSTANCE.getContinuation();
	}
	...
	public void setSetting(boolean newSetting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLModelPackage.CONTINUATION__SETTING, oldSetting, setting));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLModelPackage.CONTINUATION__SETTING:
				return isSetting();
		}

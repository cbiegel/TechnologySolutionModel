...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Change Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.emftrace.metamodel.ChangeModel.impl.AbstractChangeTypeImpl#getAbstractionLevel <em>Abstraction Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class AbstractChangeTypeImpl extends ChangeModelBaseImpl implements AbstractChangeType {
	/**
	 ...
	 * @ordered
	 */
	protected static final AbstractionLevel ABSTRACTION_LEVEL_EDEFAULT = AbstractionLevel.GENERIC;
	 ...
	 * @generated
	 */
	protected AbstractChangeTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ChangeModelPackage.Literals.ABSTRACT_CHANGE_TYPE;
	}
	...
	public void setAbstractionLevel(AbstractionLevel newAbstractionLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChangeModelPackage.ABSTRACT_CHANGE_TYPE__ABSTRACTION_LEVEL, oldAbstractionLevel, abstractionLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChangeModelPackage.ABSTRACT_CHANGE_TYPE__ABSTRACTION_LEVEL:

...
import org.emftrace.metamodel.LinkModel.LinkBase;
 ...
 * @generated
 */
public class LinkModelPackageImpl extends EPackageImpl implements LinkModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass linkBaseEClass = null;
	 ...
	 * @generated
	 */
	private EClass designAlternativesEClass = null;
	 ...
	 * @generated
	 */
	private EClass linkTypeCatalogEClass = null;
	 ...
	 * @see org.emftrace.metamodel.LinkModel.LinkModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private LinkModelPackageImpl() {
		super(eNS_URI, LinkModelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link LinkModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static LinkModelPackage init() {
		if (isInited) return (LinkModelPackage)EPackage.Registry.INSTANCE.getEPackage(LinkModelPackage.eNS_URI);

		// Obtain or create and register package
		LinkModelPackageImpl theLinkModelPackage = (LinkModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof LinkModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new LinkModelPackageImpl());
		...
		theLinkModelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(LinkModelPackage.eNS_URI, theLinkModelPackage);
		return theLinkModelPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getLinkBase() {
		return linkBaseEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getDesignAlternatives() {
		return designAlternativesEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDesignAlternatives_Name() {
		return (EAttribute)designAlternativesEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDesignAlternatives_Value() {
		return (EAttribute)designAlternativesEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDesignDecision_Choice() {
	 ...
	 * @generated
	 */
	public EAttribute getDesignDecision_Goal() {
	 ...
	 * @generated
	 */
	public EReference getDesignDecision_Alternatives() {
		return (EReference)designDecisionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTraceElement_CreatedByUser() {
	 ...
	 * @generated
	 */
	public EReference getTraceLink_DesignDecision() {
	 ...
	 * @generated
	 */
	public EAttribute getTraceLink_CreatedByRule() {
	 ...
	 * @generated
	 */
	public EAttribute getTraceLink_LastModified() {
	 ...
	 * @generated
	 */
	public EAttribute getTraceLink_LastVisited() {
		return (EAttribute)traceLinkEClass.getEStructuralFeatures().get(4);
	}
	...
	public EReference getTraceLink_Target() {
		return (EReference)traceLinkEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EReference getTrace_TraceabilityLinks() {
	 ...
	 * @generated
	 */
	public EReference getLinkType_Refinement() {
	 ...
	 * @generated
	 */
	public EClass getLinkTypeCatalog() {
		return linkTypeCatalogEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getLinkTypeCatalog_LinkTypes() {
		return (EReference)linkTypeCatalogEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLinkTypeCatalog_Name() {
		return (EAttribute)linkTypeCatalogEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLinkTypeCatalog_Description() {
		return (EAttribute)linkTypeCatalogEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getLinkContainer_Traces() {
	 ...
	 * @generated
	 */
	public EAttribute getLinkContainer_Name() {
		return (EAttribute)linkContainerEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public LinkModelFactory getLinkModelFactory() {
		return (LinkModelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		linkBaseEClass = createEClass(LINK_BASE);

		designAlternativesEClass = createEClass(DESIGN_ALTERNATIVES);
		createEAttribute(designAlternativesEClass, DESIGN_ALTERNATIVES__NAME);
		createEAttribute(designAlternativesEClass, DESIGN_ALTERNATIVES__VALUE);

		designDecisionEClass = createEClass(DESIGN_DECISION);
		createEAttribute(designDecisionEClass, DESIGN_DECISION__CHOICE);
		createEAttribute(designDecisionEClass, DESIGN_DECISION__GOAL);
		createEReference(designDecisionEClass, DESIGN_DECISION__ALTERNATIVES);

		traceElementEClass = createEClass(TRACE_ELEMENT);
		createEAttribute(traceElementEClass, TRACE_ELEMENT__NAME);
		createEAttribute(traceElementEClass, TRACE_ELEMENT__CREATED_BY_USER);

		traceLinkEClass = createEClass(TRACE_LINK);
		createEReference(traceLinkEClass, TRACE_LINK__DESIGN_DECISION);
		createEReference(traceLinkEClass, TRACE_LINK__TYPE);
		createEAttribute(traceLinkEClass, TRACE_LINK__CREATED_BY_RULE);
		createEAttribute(traceLinkEClass, TRACE_LINK__LAST_MODIFIED);
		createEAttribute(traceLinkEClass, TRACE_LINK__LAST_VISITED);
		...
		createEReference(traceEClass, TRACE__TRACEABILITY_LINKS);

		linkTypeEClass = createEClass(LINK_TYPE);
		createEAttribute(linkTypeEClass, LINK_TYPE__NAME);
		createEReference(linkTypeEClass, LINK_TYPE__REFINEMENT);

		linkTypeCatalogEClass = createEClass(LINK_TYPE_CATALOG);
		createEReference(linkTypeCatalogEClass, LINK_TYPE_CATALOG__LINK_TYPES);
		createEAttribute(linkTypeCatalogEClass, LINK_TYPE_CATALOG__NAME);
		createEAttribute(linkTypeCatalogEClass, LINK_TYPE_CATALOG__DESCRIPTION);

		linkContainerEClass = createEClass(LINK_CONTAINER);
		createEReference(linkContainerEClass, LINK_CONTAINER__LINKS);
		createEReference(linkContainerEClass, LINK_CONTAINER__TRACES);
		createEAttribute(linkContainerEClass, LINK_CONTAINER__NAME);
	}
	...
	public void initializePackageContents() {
		...
		linkBaseEClass.getESuperTypes().add(ecorePackage.getEObject());
		designAlternativesEClass.getESuperTypes().add(this.getLinkBase());
		designDecisionEClass.getESuperTypes().add(this.getLinkBase());
		traceElementEClass.getESuperTypes().add(this.getLinkBase());
		traceLinkEClass.getESuperTypes().add(this.getTraceElement());
		traceEClass.getESuperTypes().add(this.getTraceElement());
		linkTypeEClass.getESuperTypes().add(this.getLinkBase());
		linkTypeCatalogEClass.getESuperTypes().add(this.getLinkBase());
		linkContainerEClass.getESuperTypes().add(this.getLinkBase());

		// Initialize classes and features; add operations and parameters
		initEClass(linkBaseEClass, LinkBase.class, "LinkBase", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(designAlternativesEClass, DesignAlternatives.class, "DesignAlternatives", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDesignAlternatives_Name(), ecorePackage.getEString(), "Name", null, 1, 1, DesignAlternatives.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDesignAlternatives_Value(), ecorePackage.getEString(), "Value", null, 1, 1, DesignAlternatives.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(designDecisionEClass, DesignDecision.class, "DesignDecision", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDesignDecision_Choice(), ecorePackage.getEString(), "Choice", null, 1, 1, DesignDecision.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDesignDecision_Goal(), ecorePackage.getEString(), "Goal", null, 1, 1, DesignDecision.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDesignDecision_Alternatives(), this.getDesignAlternatives(), null, "Alternatives", null, 0, -1, DesignDecision.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTraceElement_CreatedByUser(), ecorePackage.getEBoolean(), "CreatedByUser", "false", 1, 1, TraceElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(traceLinkEClass, TraceLink.class, "TraceLink", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTraceLink_DesignDecision(), this.getDesignDecision(), null, "DesignDecision", null, 0, 1, TraceLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTraceLink_Type(), this.getLinkType(), null, "Type", null, 1, 1, TraceLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTraceLink_CreatedByRule(), ecorePackage.getEString(), "CreatedByRule", null, 0, 1, TraceLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTraceLink_LastModified(), ecorePackage.getEString(), "LastModified", null, 1, 1, TraceLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTraceLink_LastVisited(), ecorePackage.getEString(), "LastVisited", null, 1, 1, TraceLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTraceLink_Description(), theEcorePackage.getEString(), "Description", null, 1, 1, TraceLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(traceEClass, Trace.class, "Trace", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTrace_TraceabilityLinks(), this.getTraceLink(), null, "TraceabilityLinks", null, 0, -1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(linkTypeEClass, LinkType.class, "LinkType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLinkType_Name(), ecorePackage.getEString(), "Name", null, 1, 1, LinkType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLinkType_Refinement(), this.getLinkType(), null, "Refinement", null, 0, -1, LinkType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(linkTypeCatalogEClass, LinkTypeCatalog.class, "LinkTypeCatalog", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLinkTypeCatalog_LinkTypes(), this.getLinkType(), null, "LinkTypes", null, 0, -1, LinkTypeCatalog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkTypeCatalog_Name(), ecorePackage.getEString(), "Name", null, 1, 1, LinkTypeCatalog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkTypeCatalog_Description(), ecorePackage.getEString(), "Description", null, 1, 1, LinkTypeCatalog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(linkContainerEClass, LinkContainer.class, "LinkContainer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLinkContainer_Links(), this.getTraceLink(), null, "Links", null, 0, -1, LinkContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLinkContainer_Traces(), this.getTrace(), null, "Traces", null, 0, -1, LinkContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkContainer_Name(), ecorePackage.getEString(), "Name", null, 1, 1, LinkContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //LinkModelPackageImpl

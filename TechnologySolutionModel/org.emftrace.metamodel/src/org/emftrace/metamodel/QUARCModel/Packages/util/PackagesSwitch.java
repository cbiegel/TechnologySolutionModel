...
public class PackagesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PackagesPackage.PACKAGE_BASE: {
				PackageBase packageBase = (PackageBase)theEObject;
				T result = casePackageBase(packageBase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PackagesPackage.TOOLBOX: {
				Toolbox toolbox = (Toolbox)theEObject;
				T result = caseToolbox(toolbox);
				if (result == null) result = casePackageBase(toolbox);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Toolbox</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Toolbox</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseToolbox(Toolbox object) {
		return null;
	}

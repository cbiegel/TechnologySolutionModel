 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.SendTaskImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.SendTaskImpl#getMessageRef <em>Message Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.SendTaskImpl#getOperationRef <em>Operation Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SendTaskImpl extends TaskImpl implements SendTask {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getSendTask();
	}
	...
	public void setImplementation(String newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.SEND_TASK__IMPLEMENTATION, oldImplementation, implementation));
	}
	...
	public Message getMessageRef() {
		if (messageRef != null && messageRef.eIsProxy()) {
			...
			if (messageRef != oldMessageRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.SEND_TASK__MESSAGE_REF, oldMessageRef, messageRef));
			}
		}
		return messageRef;
	}
	...
	public void setMessageRef(Message newMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.SEND_TASK__MESSAGE_REF, oldMessageRef, messageRef));
	}
	...
	public Operation getOperationRef() {
		if (operationRef != null && operationRef.eIsProxy()) {
			...
			if (operationRef != oldOperationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.SEND_TASK__OPERATION_REF, oldOperationRef, operationRef));
			}
		}
		return operationRef;
	}
	...
	public void setOperationRef(Operation newOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.SEND_TASK__OPERATION_REF, oldOperationRef, operationRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.SEND_TASK__IMPLEMENTATION:
				return getImplementation();
			case BPMN2ModelPackage.SEND_TASK__MESSAGE_REF:
				if (resolve) return getMessageRef();
				return basicGetMessageRef();
			case BPMN2ModelPackage.SEND_TASK__OPERATION_REF:

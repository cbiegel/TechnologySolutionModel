 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.GatewayImpl#getGatewayDirection <em>Gateway Direction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class GatewayImpl extends FlowNodeImpl implements Gateway {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getGateway();
	}
	...
	public void setGatewayDirection(GatewayDirection newGatewayDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.GATEWAY__GATEWAY_DIRECTION, oldGatewayDirection, gatewayDirection));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.GATEWAY__GATEWAY_DIRECTION:

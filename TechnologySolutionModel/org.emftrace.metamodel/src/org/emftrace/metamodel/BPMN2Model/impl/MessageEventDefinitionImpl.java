 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.MessageEventDefinitionImpl#getOperationRef <em>Operation Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.MessageEventDefinitionImpl#getMessageRef <em>Message Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageEventDefinitionImpl extends EventDefinitionImpl implements MessageEventDefinition {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getMessageEventDefinition();
	}
		...
		if (operationRef != null && operationRef.eIsProxy()) {
			...
			if (operationRef != oldOperationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.MESSAGE_EVENT_DEFINITION__OPERATION_REF, oldOperationRef, operationRef));
			}
		}
		return operationRef;
	}
	...
	public void setOperationRef(Operation newOperationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.MESSAGE_EVENT_DEFINITION__OPERATION_REF, oldOperationRef, operationRef));
	}
	...
	public Message getMessageRef() {
		if (messageRef != null && messageRef.eIsProxy()) {
			...
			if (messageRef != oldMessageRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.MESSAGE_EVENT_DEFINITION__MESSAGE_REF, oldMessageRef, messageRef));
			}
		}
		return messageRef;
	}
	...
	public void setMessageRef(Message newMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.MESSAGE_EVENT_DEFINITION__MESSAGE_REF, oldMessageRef, messageRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.MESSAGE_EVENT_DEFINITION__OPERATION_REF:
				if (resolve) return getOperationRef();
				return basicGetOperationRef();
			case BPMN2ModelPackage.MESSAGE_EVENT_DEFINITION__MESSAGE_REF:

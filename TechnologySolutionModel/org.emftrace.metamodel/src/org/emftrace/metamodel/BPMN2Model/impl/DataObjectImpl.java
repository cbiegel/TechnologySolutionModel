 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.DataObjectImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.DataObjectImpl#getItemSubjectRef <em>Item Subject Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.DataObjectImpl#isIsCollection <em>Is Collection</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataObjectImpl extends FlowElementImpl implements DataObject {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getDataObject();
	}
	...
	public NotificationChain basicSetDataState(DataState newDataState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.DATA_OBJECT__DATA_STATE, oldDataState, newDataState);
	...
	public void setDataState(DataState newDataState) {
		if (newDataState != dataState) {
			...
			if (dataState != null)
				msgs = ((InternalEObject)dataState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.DATA_OBJECT__DATA_STATE, null, msgs);
			if (newDataState != null)
				msgs = ((InternalEObject)newDataState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.DATA_OBJECT__DATA_STATE, null, msgs);
			msgs = basicSetDataState(newDataState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.DATA_OBJECT__DATA_STATE, newDataState, newDataState));
	}
	...
	public ItemDefinition getItemSubjectRef() {
		if (itemSubjectRef != null && itemSubjectRef.eIsProxy()) {
			...
			if (itemSubjectRef != oldItemSubjectRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.DATA_OBJECT__ITEM_SUBJECT_REF, oldItemSubjectRef, itemSubjectRef));
			}
		}
	...
	public void setItemSubjectRef(ItemDefinition newItemSubjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.DATA_OBJECT__ITEM_SUBJECT_REF, oldItemSubjectRef, itemSubjectRef));
	}
	...
	public void setIsCollection(boolean newIsCollection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.DATA_OBJECT__IS_COLLECTION, oldIsCollection, isCollection));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.DATA_OBJECT__DATA_STATE:
				return getDataState();
			case BPMN2ModelPackage.DATA_OBJECT__ITEM_SUBJECT_REF:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ItemAwareElement.class) {
			switch (derivedFeatureID) {
				case BPMN2ModelPackage.DATA_OBJECT__DATA_STATE: return BPMN2ModelPackage.ITEM_AWARE_ELEMENT__DATA_STATE;
				case BPMN2ModelPackage.DATA_OBJECT__ITEM_SUBJECT_REF: return BPMN2ModelPackage.ITEM_AWARE_ELEMENT__ITEM_SUBJECT_REF;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ItemAwareElement.class) {
			switch (baseFeatureID) {
				case BPMN2ModelPackage.ITEM_AWARE_ELEMENT__DATA_STATE: return BPMN2ModelPackage.DATA_OBJECT__DATA_STATE;
				case BPMN2ModelPackage.ITEM_AWARE_ELEMENT__ITEM_SUBJECT_REF: return BPMN2ModelPackage.DATA_OBJECT__ITEM_SUBJECT_REF;
				default: return -1;
			}
		}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ConversationLinkImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ConversationLinkImpl#getSourceRef <em>Source Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ConversationLinkImpl#getTargetRef <em>Target Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConversationLinkImpl extends BaseElementImpl implements ConversationLink {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getConversationLink();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.CONVERSATION_LINK__NAME, oldName, name));
	}
	...
	public InteractionNode getSourceRef() {
		if (sourceRef != null && sourceRef.eIsProxy()) {
			...
			if (sourceRef != oldSourceRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.CONVERSATION_LINK__SOURCE_REF, oldSourceRef, sourceRef));
			}
		}
		return sourceRef;
	}
	...
	public void setSourceRef(InteractionNode newSourceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.CONVERSATION_LINK__SOURCE_REF, oldSourceRef, sourceRef));
	}
	...
	public InteractionNode getTargetRef() {
		if (targetRef != null && targetRef.eIsProxy()) {
			...
			if (targetRef != oldTargetRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.CONVERSATION_LINK__TARGET_REF, oldTargetRef, targetRef));
			}
		}
		return targetRef;
	}
	...
	public void setTargetRef(InteractionNode newTargetRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.CONVERSATION_LINK__TARGET_REF, oldTargetRef, targetRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.CONVERSATION_LINK__NAME:
				return getName();
			case BPMN2ModelPackage.CONVERSATION_LINK__SOURCE_REF:
				if (resolve) return getSourceRef();
				return basicGetSourceRef();
			case BPMN2ModelPackage.CONVERSATION_LINK__TARGET_REF:

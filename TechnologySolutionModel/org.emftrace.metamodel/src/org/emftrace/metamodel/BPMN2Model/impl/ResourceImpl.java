 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ResourceImpl#getResourceParameters <em>Resource Parameters</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ResourceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceImpl extends RootElementImpl implements Resource {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getResource();
	}
	...
	public EList<ResourceParameter> getResourceParameters() {
		if (resourceParameters == null) {
			resourceParameters = new EObjectContainmentEList<ResourceParameter>(ResourceParameter.class, this, BPMN2ModelPackage.RESOURCE__RESOURCE_PARAMETERS);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.RESOURCE__NAME, oldName, name));
	}

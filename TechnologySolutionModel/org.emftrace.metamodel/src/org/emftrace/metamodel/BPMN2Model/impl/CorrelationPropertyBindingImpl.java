 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CorrelationPropertyBindingImpl#getDataPath <em>Data Path</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CorrelationPropertyBindingImpl#getCorrelationPropertyRef <em>Correlation Property Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CorrelationPropertyBindingImpl extends BaseElementImpl implements CorrelationPropertyBinding {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getCorrelationPropertyBinding();
	}
	...
	public NotificationChain basicSetDataPath(FormalExpression newDataPath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.CORRELATION_PROPERTY_BINDING__DATA_PATH, oldDataPath, newDataPath);
	...
	public void setDataPath(FormalExpression newDataPath) {
		if (newDataPath != dataPath) {
			...
			if (dataPath != null)
				msgs = ((InternalEObject)dataPath).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.CORRELATION_PROPERTY_BINDING__DATA_PATH, null, msgs);
			if (newDataPath != null)
				msgs = ((InternalEObject)newDataPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.CORRELATION_PROPERTY_BINDING__DATA_PATH, null, msgs);
			msgs = basicSetDataPath(newDataPath, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.CORRELATION_PROPERTY_BINDING__DATA_PATH, newDataPath, newDataPath));
	}
	...
	public CorrelationProperty getCorrelationPropertyRef() {
		if (correlationPropertyRef != null && correlationPropertyRef.eIsProxy()) {
			...
			if (correlationPropertyRef != oldCorrelationPropertyRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.CORRELATION_PROPERTY_BINDING__CORRELATION_PROPERTY_REF, oldCorrelationPropertyRef, correlationPropertyRef));
			}
		}
	...
	public void setCorrelationPropertyRef(CorrelationProperty newCorrelationPropertyRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.CORRELATION_PROPERTY_BINDING__CORRELATION_PROPERTY_REF, oldCorrelationPropertyRef, correlationPropertyRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMN2ModelPackage.CORRELATION_PROPERTY_BINDING__DATA_PATH:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.CORRELATION_PROPERTY_BINDING__DATA_PATH:
				return getDataPath();
			case BPMN2ModelPackage.CORRELATION_PROPERTY_BINDING__CORRELATION_PROPERTY_REF:

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getParticipants <em>Participants</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getMessageFlows <em>Message Flows</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getArtifacts <em>Artifacts</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getConversations <em>Conversations</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getConversationAssociations <em>Conversation Associations</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getParticipantAssociations <em>Participant Associations</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getMessageFlowAssociations <em>Message Flow Associations</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getCorrelationKeys <em>Correlation Keys</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getChoreographyRef <em>Choreography Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getConversationLinks <em>Conversation Links</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#isIsClosed <em>Is Closed</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CollaborationImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollaborationImpl extends RootElementImpl implements Collaboration {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getCollaboration();
	}
	...
	public EList<Participant> getParticipants() {
		if (participants == null) {
			participants = new EObjectContainmentEList<Participant>(Participant.class, this, BPMN2ModelPackage.COLLABORATION__PARTICIPANTS);
		}
		return participants;
	}
	...
	public EList<MessageFlow> getMessageFlows() {
		if (messageFlows == null) {
			messageFlows = new EObjectContainmentEList<MessageFlow>(MessageFlow.class, this, BPMN2ModelPackage.COLLABORATION__MESSAGE_FLOWS);
		}
		return messageFlows;
	}
	...
	public EList<Artifact> getArtifacts() {
		if (artifacts == null) {
			artifacts = new EObjectContainmentEList<Artifact>(Artifact.class, this, BPMN2ModelPackage.COLLABORATION__ARTIFACTS);
		}
		return artifacts;
	}
	...
	public EList<ConversationNode> getConversations() {
		if (conversations == null) {
			conversations = new EObjectContainmentEList<ConversationNode>(ConversationNode.class, this, BPMN2ModelPackage.COLLABORATION__CONVERSATIONS);
		}
	...
	public NotificationChain basicSetConversationAssociations(ConversationAssociation newConversationAssociations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.COLLABORATION__CONVERSATION_ASSOCIATIONS, oldConversationAssociations, newConversationAssociations);
	...
	public void setConversationAssociations(ConversationAssociation newConversationAssociations) {
		if (newConversationAssociations != conversationAssociations) {
			...
			if (conversationAssociations != null)
				msgs = ((InternalEObject)conversationAssociations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.COLLABORATION__CONVERSATION_ASSOCIATIONS, null, msgs);
			if (newConversationAssociations != null)
				msgs = ((InternalEObject)newConversationAssociations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.COLLABORATION__CONVERSATION_ASSOCIATIONS, null, msgs);
			msgs = basicSetConversationAssociations(newConversationAssociations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.COLLABORATION__CONVERSATION_ASSOCIATIONS, newConversationAssociations, newConversationAssociations));
	}
	...
	public EList<ParticipantAssociation> getParticipantAssociations() {
		if (participantAssociations == null) {
			participantAssociations = new EObjectContainmentEList<ParticipantAssociation>(ParticipantAssociation.class, this, BPMN2ModelPackage.COLLABORATION__PARTICIPANT_ASSOCIATIONS);
		}
	...
	public EList<MessageFlowAssociation> getMessageFlowAssociations() {
		if (messageFlowAssociations == null) {
			messageFlowAssociations = new EObjectContainmentEList<MessageFlowAssociation>(MessageFlowAssociation.class, this, BPMN2ModelPackage.COLLABORATION__MESSAGE_FLOW_ASSOCIATIONS);
		}
	...
	public EList<CorrelationKey> getCorrelationKeys() {
		if (correlationKeys == null) {
			correlationKeys = new EObjectContainmentEList<CorrelationKey>(CorrelationKey.class, this, BPMN2ModelPackage.COLLABORATION__CORRELATION_KEYS);
		}
	...
	public EList<Choreography> getChoreographyRef() {
		if (choreographyRef == null) {
			choreographyRef = new EObjectResolvingEList<Choreography>(Choreography.class, this, BPMN2ModelPackage.COLLABORATION__CHOREOGRAPHY_REF);
		}
	...
	public EList<ConversationLink> getConversationLinks() {
		if (conversationLinks == null) {
			conversationLinks = new EObjectContainmentEList<ConversationLink>(ConversationLink.class, this, BPMN2ModelPackage.COLLABORATION__CONVERSATION_LINKS);
		}
	...
	public void setIsClosed(boolean newIsClosed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.COLLABORATION__IS_CLOSED, oldIsClosed, isClosed));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.COLLABORATION__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case BPMN2ModelPackage.COLLABORATION__ARTIFACTS:
				return ((InternalEList<?>)getArtifacts()).basicRemove(otherEnd, msgs);
			case BPMN2ModelPackage.COLLABORATION__CONVERSATIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMN2ModelPackage.COLLABORATION__CHOREOGRAPHY_REF:

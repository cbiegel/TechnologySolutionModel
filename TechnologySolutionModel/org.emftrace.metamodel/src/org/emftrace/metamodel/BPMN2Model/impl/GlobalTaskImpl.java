 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.GlobalTaskImpl#getResources <em>Resources</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GlobalTaskImpl extends CallableElementImpl implements GlobalTask {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getGlobalTask();
	}
	...
	public EList<ResourceRole> getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList<ResourceRole>(ResourceRole.class, this, BPMN2ModelPackage.GLOBAL_TASK__RESOURCES);
		}
		return resources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMN2ModelPackage.GLOBAL_TASK__RESOURCES:

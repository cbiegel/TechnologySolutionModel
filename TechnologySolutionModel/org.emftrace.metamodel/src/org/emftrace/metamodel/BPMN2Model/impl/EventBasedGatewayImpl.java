 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.EventBasedGatewayImpl#getEventGatewayType <em>Event Gateway Type</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.EventBasedGatewayImpl#isInstantiate <em>Instantiate</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventBasedGatewayImpl extends GatewayImpl implements EventBasedGateway {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getEventBasedGateway();
	}
	...
	public void setEventGatewayType(EventBasedGatewayType newEventGatewayType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.EVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE, oldEventGatewayType, eventGatewayType));
	}
	...
	public void setInstantiate(boolean newInstantiate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.EVENT_BASED_GATEWAY__INSTANTIATE, oldInstantiate, instantiate));
	}

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ExclusiveGatewayImpl#getDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExclusiveGatewayImpl extends GatewayImpl implements ExclusiveGateway {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getExclusiveGateway();
	}
		...
		if (default_ != null && default_.eIsProxy()) {
			...
			if (default_ != oldDefault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.EXCLUSIVE_GATEWAY__DEFAULT, oldDefault, default_));
			}
		}
		return default_;
	}
	...
	public void setDefault(SequenceFlow newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.EXCLUSIVE_GATEWAY__DEFAULT, oldDefault, default_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.EXCLUSIVE_GATEWAY__DEFAULT:

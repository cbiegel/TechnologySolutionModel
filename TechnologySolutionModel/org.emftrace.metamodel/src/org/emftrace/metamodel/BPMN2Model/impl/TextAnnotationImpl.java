 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.TextAnnotationImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.TextAnnotationImpl#getTextFormat <em>Text Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextAnnotationImpl extends ArtifactImpl implements TextAnnotation {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getTextAnnotation();
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.TEXT_ANNOTATION__TEXT, oldText, text));
	}
	...
	public void setTextFormat(String newTextFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.TEXT_ANNOTATION__TEXT_FORMAT, oldTextFormat, textFormat));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.TEXT_ANNOTATION__TEXT:
				return getText();
			case BPMN2ModelPackage.TEXT_ANNOTATION__TEXT_FORMAT:

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.PartnerEntityImpl#getParticipantRef <em>Participant Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.PartnerEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PartnerEntityImpl extends RootElementImpl implements PartnerEntity {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getPartnerEntity();
	}
	...
	public EList<Participant> getParticipantRef() {
		if (participantRef == null) {
			participantRef = new EObjectResolvingEList<Participant>(Participant.class, this, BPMN2ModelPackage.PARTNER_ENTITY__PARTICIPANT_REF);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.PARTNER_ENTITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.PARTNER_ENTITY__PARTICIPANT_REF:

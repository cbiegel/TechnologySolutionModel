 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.OperationImpl#getInMessageRef <em>In Message Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.OperationImpl#getOutMessageRef <em>Out Message Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.OperationImpl#getErrorRefs <em>Error Refs</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.OperationImpl#getImplementationRef <em>Implementation Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.OperationImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationImpl extends BaseElementImpl implements Operation {
	 ...
	 * @ordered
	 */
	protected EList<org.emftrace.metamodel.BPMN2Model.Error> errorRefs;
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getOperation();
	}
		...
		if (inMessageRef != null && inMessageRef.eIsProxy()) {
			...
			if (inMessageRef != oldInMessageRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.OPERATION__IN_MESSAGE_REF, oldInMessageRef, inMessageRef));
			}
		}
		return inMessageRef;
	}
	...
	public void setInMessageRef(Message newInMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.OPERATION__IN_MESSAGE_REF, oldInMessageRef, inMessageRef));
	}
	...
	public Message getOutMessageRef() {
		if (outMessageRef != null && outMessageRef.eIsProxy()) {
			...
			if (outMessageRef != oldOutMessageRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.OPERATION__OUT_MESSAGE_REF, oldOutMessageRef, outMessageRef));
			}
		}
	...
	public void setOutMessageRef(Message newOutMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.OPERATION__OUT_MESSAGE_REF, oldOutMessageRef, outMessageRef));
	}
	 ...
	 * @generated
	 */
	public EList<org.emftrace.metamodel.BPMN2Model.Error> getErrorRefs() {
		if (errorRefs == null) {
			errorRefs = new EObjectResolvingEList<org.emftrace.metamodel.BPMN2Model.Error>(org.emftrace.metamodel.BPMN2Model.Error.class, this, BPMN2ModelPackage.OPERATION__ERROR_REFS);
		}
		return errorRefs;
	}
	...
	public EObject getImplementationRef() {
		if (implementationRef != null && implementationRef.eIsProxy()) {
			...
			if (implementationRef != oldImplementationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.OPERATION__IMPLEMENTATION_REF, oldImplementationRef, implementationRef));
			}
		}
	...
	public void setImplementationRef(EObject newImplementationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.OPERATION__IMPLEMENTATION_REF, oldImplementationRef, implementationRef));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.OPERATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.OPERATION__IN_MESSAGE_REF:
				if (resolve) return getInMessageRef();
				return basicGetInMessageRef();
			case BPMN2ModelPackage.OPERATION__OUT_MESSAGE_REF:
				if (resolve) return getOutMessageRef();
				return basicGetOutMessageRef();
			case BPMN2ModelPackage.OPERATION__ERROR_REFS:
				return getErrorRefs();
			case BPMN2ModelPackage.OPERATION__IMPLEMENTATION_REF:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case BPMN2ModelPackage.OPERATION__ERROR_REFS:
				getErrorRefs().clear();
				getErrorRefs().addAll((Collection<? extends org.emftrace.metamodel.BPMN2Model.Error>)newValue);
				return;
			case BPMN2ModelPackage.OPERATION__IMPLEMENTATION_REF:

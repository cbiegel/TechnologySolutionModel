 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CorrelationKeyImpl#getCorrelationPropertyRef <em>Correlation Property Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CorrelationKeyImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CorrelationKeyImpl extends BaseElementImpl implements CorrelationKey {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getCorrelationKey();
	}
	...
	public EList<CorrelationProperty> getCorrelationPropertyRef() {
		if (correlationPropertyRef == null) {
			correlationPropertyRef = new EObjectResolvingEList<CorrelationProperty>(CorrelationProperty.class, this, BPMN2ModelPackage.CORRELATION_KEY__CORRELATION_PROPERTY_REF);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.CORRELATION_KEY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.CORRELATION_KEY__CORRELATION_PROPERTY_REF:
				return getCorrelationPropertyRef();
			case BPMN2ModelPackage.CORRELATION_KEY__NAME:
				return getName();
		}

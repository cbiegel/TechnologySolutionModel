 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.MessageFlowImpl#getMessageRef <em>Message Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.MessageFlowImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.MessageFlowImpl#getSourceRef <em>Source Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.MessageFlowImpl#getTargetRef <em>Target Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageFlowImpl extends BaseElementImpl implements MessageFlow {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getMessageFlow();
	}
		...
		if (messageRef != null && messageRef.eIsProxy()) {
			...
			if (messageRef != oldMessageRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.MESSAGE_FLOW__MESSAGE_REF, oldMessageRef, messageRef));
			}
		}
		return messageRef;
	}
	...
	public void setMessageRef(Message newMessageRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.MESSAGE_FLOW__MESSAGE_REF, oldMessageRef, messageRef));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.MESSAGE_FLOW__NAME, oldName, name));
	}
	...
	public InteractionNode getSourceRef() {
		if (sourceRef != null && sourceRef.eIsProxy()) {
			...
			if (sourceRef != oldSourceRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.MESSAGE_FLOW__SOURCE_REF, oldSourceRef, sourceRef));
			}
		}
		return sourceRef;
	}
	...
	public void setSourceRef(InteractionNode newSourceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.MESSAGE_FLOW__SOURCE_REF, oldSourceRef, sourceRef));
	}
	...
	public InteractionNode getTargetRef() {
		if (targetRef != null && targetRef.eIsProxy()) {
			...
			if (targetRef != oldTargetRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.MESSAGE_FLOW__TARGET_REF, oldTargetRef, targetRef));
			}
		}
		return targetRef;
	}
	...
	public void setTargetRef(InteractionNode newTargetRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.MESSAGE_FLOW__TARGET_REF, oldTargetRef, targetRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.MESSAGE_FLOW__MESSAGE_REF:
				if (resolve) return getMessageRef();
				return basicGetMessageRef();
			case BPMN2ModelPackage.MESSAGE_FLOW__NAME:
				return getName();
			case BPMN2ModelPackage.MESSAGE_FLOW__SOURCE_REF:
				if (resolve) return getSourceRef();
				return basicGetSourceRef();
			case BPMN2ModelPackage.MESSAGE_FLOW__TARGET_REF:

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ComplexGatewayImpl#getActivationCondition <em>Activation Condition</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ComplexGatewayImpl#getDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComplexGatewayImpl extends GatewayImpl implements ComplexGateway {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getComplexGateway();
	}
	...
	public NotificationChain basicSetActivationCondition(Expression newActivationCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.COMPLEX_GATEWAY__ACTIVATION_CONDITION, oldActivationCondition, newActivationCondition);
	...
	public void setActivationCondition(Expression newActivationCondition) {
		if (newActivationCondition != activationCondition) {
			...
			if (activationCondition != null)
				msgs = ((InternalEObject)activationCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.COMPLEX_GATEWAY__ACTIVATION_CONDITION, null, msgs);
			if (newActivationCondition != null)
				msgs = ((InternalEObject)newActivationCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.COMPLEX_GATEWAY__ACTIVATION_CONDITION, null, msgs);
			msgs = basicSetActivationCondition(newActivationCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.COMPLEX_GATEWAY__ACTIVATION_CONDITION, newActivationCondition, newActivationCondition));
	}
	...
	public SequenceFlow getDefault() {
		if (default_ != null && default_.eIsProxy()) {
			...
			if (default_ != oldDefault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.COMPLEX_GATEWAY__DEFAULT, oldDefault, default_));
			}
		}
		return default_;
	}
	...
	public void setDefault(SequenceFlow newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.COMPLEX_GATEWAY__DEFAULT, oldDefault, default_));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMN2ModelPackage.COMPLEX_GATEWAY__ACTIVATION_CONDITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMN2ModelPackage.COMPLEX_GATEWAY__DEFAULT:

 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.MessageImpl#getItemRef <em>Item Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.MessageImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageImpl extends RootElementImpl implements Message {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getMessage();
	}
		...
		if (itemRef != null && itemRef.eIsProxy()) {
			...
			if (itemRef != oldItemRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.MESSAGE__ITEM_REF, oldItemRef, itemRef));
			}
		}
		return itemRef;
	}
	...
	public void setItemRef(ItemDefinition newItemRef) {
		...
		itemRef = newItemRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.MESSAGE__ITEM_REF, oldItemRef, itemRef));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.MESSAGE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.MESSAGE__ITEM_REF:
				if (resolve) return getItemRef();
				return basicGetItemRef();
			case BPMN2ModelPackage.MESSAGE__NAME:
				return getName();
		}

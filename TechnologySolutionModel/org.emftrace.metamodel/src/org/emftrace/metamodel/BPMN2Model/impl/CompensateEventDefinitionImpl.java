 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CompensateEventDefinitionImpl#getActivityRef <em>Activity Ref</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.CompensateEventDefinitionImpl#isWaitForCompletion <em>Wait For Completion</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompensateEventDefinitionImpl extends EventDefinitionImpl implements CompensateEventDefinition {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getCompensateEventDefinition();
	}
		...
		if (activityRef != null && activityRef.eIsProxy()) {
			...
			if (activityRef != oldActivityRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.COMPENSATE_EVENT_DEFINITION__ACTIVITY_REF, oldActivityRef, activityRef));
			}
		}
		return activityRef;
	}
	...
	public void setActivityRef(Activity newActivityRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.COMPENSATE_EVENT_DEFINITION__ACTIVITY_REF, oldActivityRef, activityRef));
	}
	...
	public void setWaitForCompletion(boolean newWaitForCompletion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.COMPENSATE_EVENT_DEFINITION__WAIT_FOR_COMPLETION, oldWaitForCompletion, waitForCompletion));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMN2ModelPackage.COMPENSATE_EVENT_DEFINITION__ACTIVITY_REF:
				if (resolve) return getActivityRef();
				return basicGetActivityRef();
			case BPMN2ModelPackage.COMPENSATE_EVENT_DEFINITION__WAIT_FOR_COMPLETION:

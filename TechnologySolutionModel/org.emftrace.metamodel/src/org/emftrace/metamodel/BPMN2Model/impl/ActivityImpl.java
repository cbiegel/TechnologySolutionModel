 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getIoSpecification <em>Io Specification</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getBoundaryEventRefs <em>Boundary Event Refs</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getDataInputAssociations <em>Data Input Associations</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getDataOutputAssociations <em>Data Output Associations</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getLoopCharacteristics <em>Loop Characteristics</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getCompletionQuantity <em>Completion Quantity</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#isIsForCompensation <em>Is For Compensation</em>}</li>
 *   <li>{@link org.emftrace.metamodel.BPMN2Model.impl.ActivityImpl#getStartQuantity <em>Start Quantity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityImpl extends FlowNodeImpl implements Activity {
	...
	protected EClass eStaticClass() {
		return BPMN2ModelPackage.eINSTANCE.getActivity();
	}
	...
	public NotificationChain basicSetIoSpecification(InputOutputSpecification newIoSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.ACTIVITY__IO_SPECIFICATION, oldIoSpecification, newIoSpecification);
	...
	public void setIoSpecification(InputOutputSpecification newIoSpecification) {
		if (newIoSpecification != ioSpecification) {
			...
			if (ioSpecification != null)
				msgs = ((InternalEObject)ioSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.ACTIVITY__IO_SPECIFICATION, null, msgs);
			if (newIoSpecification != null)
				msgs = ((InternalEObject)newIoSpecification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.ACTIVITY__IO_SPECIFICATION, null, msgs);
			msgs = basicSetIoSpecification(newIoSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.ACTIVITY__IO_SPECIFICATION, newIoSpecification, newIoSpecification));
	}
	...
	public EList<BoundaryEvent> getBoundaryEventRefs() {
		if (boundaryEventRefs == null) {
			boundaryEventRefs = new EObjectWithInverseResolvingEList<BoundaryEvent>(BoundaryEvent.class, this, BPMN2ModelPackage.ACTIVITY__BOUNDARY_EVENT_REFS, BPMN2ModelPackage.BOUNDARY_EVENT__ATTACHED_TO_REF);
		}
	...
	public EList<Property> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<Property>(Property.class, this, BPMN2ModelPackage.ACTIVITY__PROPERTIES);
		}
		return properties;
	}
	...
	public EList<DataInputAssociation> getDataInputAssociations() {
		if (dataInputAssociations == null) {
			dataInputAssociations = new EObjectContainmentEList<DataInputAssociation>(DataInputAssociation.class, this, BPMN2ModelPackage.ACTIVITY__DATA_INPUT_ASSOCIATIONS);
		}
	...
	public EList<DataOutputAssociation> getDataOutputAssociations() {
		if (dataOutputAssociations == null) {
			dataOutputAssociations = new EObjectContainmentEList<DataOutputAssociation>(DataOutputAssociation.class, this, BPMN2ModelPackage.ACTIVITY__DATA_OUTPUT_ASSOCIATIONS);
		}
	...
	public EList<ResourceRole> getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList<ResourceRole>(ResourceRole.class, this, BPMN2ModelPackage.ACTIVITY__RESOURCES);
		}
		return resources;
	}
	...
	public NotificationChain basicSetLoopCharacteristics(LoopCharacteristics newLoopCharacteristics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.ACTIVITY__LOOP_CHARACTERISTICS, oldLoopCharacteristics, newLoopCharacteristics);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoopCharacteristics(LoopCharacteristics newLoopCharacteristics) {
		if (newLoopCharacteristics != loopCharacteristics) {
			...
			if (loopCharacteristics != null)
				msgs = ((InternalEObject)loopCharacteristics).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.ACTIVITY__LOOP_CHARACTERISTICS, null, msgs);
			if (newLoopCharacteristics != null)
				msgs = ((InternalEObject)newLoopCharacteristics).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BPMN2ModelPackage.ACTIVITY__LOOP_CHARACTERISTICS, null, msgs);
			msgs = basicSetLoopCharacteristics(newLoopCharacteristics, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.ACTIVITY__LOOP_CHARACTERISTICS, newLoopCharacteristics, newLoopCharacteristics));
	}
	...
	public void setCompletionQuantity(int newCompletionQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.ACTIVITY__COMPLETION_QUANTITY, oldCompletionQuantity, completionQuantity));
	}
	...
	public SequenceFlow getDefault() {
		if (default_ != null && default_.eIsProxy()) {
			...
			if (default_ != oldDefault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMN2ModelPackage.ACTIVITY__DEFAULT, oldDefault, default_));
			}
		}
		return default_;
	}
	...
	public void setDefault(SequenceFlow newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.ACTIVITY__DEFAULT, oldDefault, default_));
	}
	...
	public void setIsForCompensation(boolean newIsForCompensation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.ACTIVITY__IS_FOR_COMPENSATION, oldIsForCompensation, isForCompensation));
	}
	...
	public void setStartQuantity(int newStartQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMN2ModelPackage.ACTIVITY__START_QUANTITY, oldStartQuantity, startQuantity));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMN2ModelPackage.ACTIVITY__BOUNDARY_EVENT_REFS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case BPMN2ModelPackage.ACTIVITY__RESOURCES:
				return ((InternalEList<?>)getResources()).basicRemove(otherEnd, msgs);
			case BPMN2ModelPackage.ACTIVITY__LOOP_CHARACTERISTICS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BPMN2ModelPackage.ACTIVITY__DEFAULT:

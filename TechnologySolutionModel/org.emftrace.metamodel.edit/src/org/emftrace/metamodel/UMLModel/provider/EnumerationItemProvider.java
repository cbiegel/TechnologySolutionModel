...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.Enumeration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Enumeration_ownedLiteral_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Enumeration_ownedLiteral_feature", "_UI_Enumeration_type"),
				 UMLModelPackage.eINSTANCE.getEnumeration_OwnedLiteral(),
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getEnumeration_OwnedLiteral());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Enumeration.class)) {
			case UMLModelPackage.ENUMERATION__OWNED_LITERAL:

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addScopePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_scope_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_scope_feature", "_UI_Variable_type"),
				 UMLModelPackage.eINSTANCE.getVariable_Scope(),
				 true,
				 false,
				 false,
	...
	protected void addActivityScopePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_activityScope_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_activityScope_feature", "_UI_Variable_type"),
				 UMLModelPackage.eINSTANCE.getVariable_ActivityScope(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.Deployment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getDeployment_DeployedArtifact(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Deployment_configuration_feature", "_UI_Deployment_type"),
				 UMLModelPackage.eINSTANCE.getDeployment_Configuration(),
				 true,
				 false,
				 false,
				 null,
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Deployment_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Deployment_location_feature", "_UI_Deployment_type"),
				 UMLModelPackage.eINSTANCE.getDeployment_Location(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getDeployment_Configuration());
		}

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.RemoveStructuralFeatureValueAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RemoveStructuralFeatureValueActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getRemoveStructuralFeatureValueAction_IsRemoveDuplicates(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RemoveStructuralFeatureValueAction_removeAt_feature", "_UI_RemoveStructuralFeatureValueAction_type"),
				 UMLModelPackage.eINSTANCE.getRemoveStructuralFeatureValueAction_RemoveAt(),
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getRemoveStructuralFeatureValueAction_RemoveAt());
		}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == UMLModelPackage.eINSTANCE.getStructuralFeatureAction_Object() ||
			childFeature == UMLModelPackage.eINSTANCE.getWriteStructuralFeatureAction_Value() ||
			childFeature == UMLModelPackage.eINSTANCE.getRemoveStructuralFeatureValueAction_RemoveAt();

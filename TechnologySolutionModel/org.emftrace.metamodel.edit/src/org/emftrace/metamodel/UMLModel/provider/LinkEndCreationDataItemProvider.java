...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.LinkEndCreationData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkEndCreationDataItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getLinkEndCreationData_IsReplaceAll(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getLinkEndCreationData_InsertAt(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((LinkEndCreationData)object).getUmlID();

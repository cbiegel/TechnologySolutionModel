...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.PackageMerge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageMergeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getPackageMerge_MergedPackage(),
				 true,
				 false,
				 false,
	...
	protected void addReceivingPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PackageMerge_receivingPackage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PackageMerge_receivingPackage_feature", "_UI_PackageMerge_type"),
				 UMLModelPackage.eINSTANCE.getPackageMerge_ReceivingPackage(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((PackageMerge)object).getUmlID();
		return label == null || label.length() == 0 ?
			getString("_UI_PackageMerge_type") :
			getString("_UI_PackageMerge_type") + " " + label;
	}

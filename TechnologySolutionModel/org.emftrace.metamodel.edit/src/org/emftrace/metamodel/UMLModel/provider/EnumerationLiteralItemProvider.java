...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.EnumerationLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationLiteralItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumerationLiteral_enumeration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumerationLiteral_enumeration_feature", "_UI_EnumerationLiteral_type"),
				 UMLModelPackage.eINSTANCE.getEnumerationLiteral_Enumeration(),
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EnumerationLiteral.class)) {
			case UMLModelPackage.ENUMERATION_LITERAL__ENUMERATION:

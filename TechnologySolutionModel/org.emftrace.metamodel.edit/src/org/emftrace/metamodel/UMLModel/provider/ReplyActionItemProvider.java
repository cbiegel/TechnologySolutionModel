...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.ReplyAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReplyActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getReplyAction_ReplyToCall(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ReplyAction_returnInformation_feature", "_UI_ReplyAction_type"),
				 UMLModelPackage.eINSTANCE.getReplyAction_ReturnInformation(),
				 true,
				 false,
				 false,
				 null,
	...
	protected void addReplyValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReplyAction_replyValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReplyAction_replyValue_feature", "_UI_ReplyAction_type"),
				 UMLModelPackage.eINSTANCE.getReplyAction_ReplyValue(),
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getReplyAction_ReturnInformation());
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getReplyAction_ReplyValue());
		}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == UMLModelPackage.eINSTANCE.getReplyAction_ReturnInformation() ||
			childFeature == UMLModelPackage.eINSTANCE.getReplyAction_ReplyValue();

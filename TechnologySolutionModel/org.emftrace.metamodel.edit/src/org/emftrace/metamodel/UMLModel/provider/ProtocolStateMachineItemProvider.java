...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.ProtocolStateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProtocolStateMachineItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProtocolStateMachine_conformance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProtocolStateMachine_conformance_feature", "_UI_ProtocolStateMachine_type"),
				 UMLModelPackage.eINSTANCE.getProtocolStateMachine_Conformance(),
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getProtocolStateMachine_Conformance());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProtocolStateMachine.class)) {
			case UMLModelPackage.PROTOCOL_STATE_MACHINE__CONFORMANCE:

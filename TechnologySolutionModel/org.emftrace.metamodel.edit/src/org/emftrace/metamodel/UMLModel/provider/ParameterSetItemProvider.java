...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.ParameterSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterSetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getParameterSet_Parameter(),
				 true,
				 false,
				 false,
	...
	protected void addConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterSet_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterSet_condition_feature", "_UI_ParameterSet_type"),
				 UMLModelPackage.eINSTANCE.getParameterSet_Condition(),
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getParameterSet_Condition());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParameterSet.class)) {
			case UMLModelPackage.PARAMETER_SET__PARAMETER:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case UMLModelPackage.PARAMETER_SET__CONDITION:

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.ReadLinkObjectEndQualifierAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReadLinkObjectEndQualifierActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReadLinkObjectEndQualifierAction_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReadLinkObjectEndQualifierAction_object_feature", "_UI_ReadLinkObjectEndQualifierAction_type"),
				 UMLModelPackage.eINSTANCE.getReadLinkObjectEndQualifierAction_Object(),
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ReadLinkObjectEndQualifierAction_result_feature", "_UI_ReadLinkObjectEndQualifierAction_type"),
				 UMLModelPackage.eINSTANCE.getReadLinkObjectEndQualifierAction_Result(),
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getReadLinkObjectEndQualifierAction_Qualifier(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getReadLinkObjectEndQualifierAction_Object());
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getReadLinkObjectEndQualifierAction_Result());
		}

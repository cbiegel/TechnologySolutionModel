...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.DataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getDataType_OwnedAttribute(),
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getDataType_OwnedOperation(),
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getDataType_OwnedAttribute());
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getDataType_OwnedOperation());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataType.class)) {
			case UMLModelPackage.DATA_TYPE__OWNED_ATTRIBUTE:
			case UMLModelPackage.DATA_TYPE__OWNED_OPERATION:

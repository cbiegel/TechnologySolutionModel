...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.TemplateBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TemplateBindingItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getTemplateBinding_Signature(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TemplateBinding_parameterSubstitution_feature", "_UI_TemplateBinding_type"),
				 UMLModelPackage.eINSTANCE.getTemplateBinding_ParameterSubstitution(),
				 true,
				 false,
				 false,
				 null,
	...
	protected void addBoundElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TemplateBinding_boundElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TemplateBinding_boundElement_feature", "_UI_TemplateBinding_type"),
				 UMLModelPackage.eINSTANCE.getTemplateBinding_BoundElement(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getTemplateBinding_ParameterSubstitution());
		}
	...
	public String getText(Object object) {
		String label = ((TemplateBinding)object).getUmlID();

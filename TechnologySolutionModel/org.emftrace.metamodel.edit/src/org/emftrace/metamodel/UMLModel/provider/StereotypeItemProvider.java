...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.Stereotype} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StereotypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Stereotype_icon_feature", "_UI_Stereotype_type"),
				 UMLModelPackage.eINSTANCE.getStereotype_Icon(),
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getStereotype_Icon());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Stereotype.class)) {
			case UMLModelPackage.STEREOTYPE__ICON:

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.LinkAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkAction_endData_feature", "_UI_LinkAction_type"),
				 UMLModelPackage.eINSTANCE.getLinkAction_EndData(),
				 true,
				 false,
				 false,
				 null,
	...
	protected void addInputValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkAction_inputValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkAction_inputValue_feature", "_UI_LinkAction_type"),
				 UMLModelPackage.eINSTANCE.getLinkAction_InputValue(),
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getLinkAction_EndData());
			childrenFeatures.add(UMLModelPackage.eINSTANCE.getLinkAction_InputValue());
		}

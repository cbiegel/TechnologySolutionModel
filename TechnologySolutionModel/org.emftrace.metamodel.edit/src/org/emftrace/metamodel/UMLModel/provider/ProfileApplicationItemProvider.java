...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.ProfileApplication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfileApplicationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getProfileApplication_AppliedProfile(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getProfileApplication_IsStrict(),
				 true,
				 false,
				 false,
	...
	protected void addApplyingPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProfileApplication_applyingPackage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileApplication_applyingPackage_feature", "_UI_ProfileApplication_type"),
				 UMLModelPackage.eINSTANCE.getProfileApplication_ApplyingPackage(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ProfileApplication)object).getUmlID();

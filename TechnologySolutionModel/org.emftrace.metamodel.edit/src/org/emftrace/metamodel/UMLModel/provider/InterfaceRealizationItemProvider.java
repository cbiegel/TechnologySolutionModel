...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.InterfaceRealization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getInterfaceRealization_Contract(),
				 true,
				 false,
				 false,
	...
	protected void addRealizingClassifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InterfaceRealization_realizingClassifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InterfaceRealization_realizingClassifier_feature", "_UI_InterfaceRealization_type"),
				 UMLModelPackage.eINSTANCE.getInterfaceRealization_RealizingClassifier(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.UMLModel.ProtocolConformance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProtocolConformanceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UMLModelPackage.eINSTANCE.getProtocolConformance_GeneralMachine(),
				 true,
				 false,
				 false,
	...
	protected void addSpecificMachinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProtocolConformance_specificMachine_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProtocolConformance_specificMachine_feature", "_UI_ProtocolConformance_type"),
				 UMLModelPackage.eINSTANCE.getProtocolConformance_SpecificMachine(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ProtocolConformance)object).getUmlID();
		return label == null || label.length() == 0 ?
			getString("_UI_ProtocolConformance_type") :
			getString("_UI_ProtocolConformance_type") + " " + label;
	}

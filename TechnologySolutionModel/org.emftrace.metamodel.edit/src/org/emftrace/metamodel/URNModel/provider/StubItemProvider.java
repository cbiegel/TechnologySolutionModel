...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.Stub} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StubItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stub_dynamic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stub_dynamic_feature", "_UI_Stub_type"),
				 URNModelPackage.Literals.STUB__DYNAMIC,
				 true,
				 false,
				 false,
	...
	protected void addSynchronizingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stub_synchronizing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stub_synchronizing_feature", "_UI_Stub_type"),
				 URNModelPackage.Literals.STUB__SYNCHRONIZING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addBlockingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stub_blocking_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stub_blocking_feature", "_UI_Stub_type"),
				 URNModelPackage.Literals.STUB__BLOCKING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addBindingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stub_bindings_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stub_bindings_feature", "_UI_Stub_type"),
				 URNModelPackage.Literals.STUB__BINDINGS,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(URNModelPackage.Literals.STUB__BINDINGS);
		}
	...
	public String getText(Object object) {
		String label = ((Stub)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Stub_type") :
			getString("_UI_Stub_type") + " " + label;
	}

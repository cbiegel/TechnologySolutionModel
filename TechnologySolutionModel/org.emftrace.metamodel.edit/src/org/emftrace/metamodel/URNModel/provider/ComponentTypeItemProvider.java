...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.ComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentType_instances_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentType_instances_feature", "_UI_ComponentType_type"),
				 URNModelPackage.Literals.COMPONENT_TYPE__INSTANCES,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ComponentType.class)) {
			case URNModelPackage.COMPONENT_TYPE__INSTANCES:

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.EnumerationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumerationType_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumerationType_values_feature", "_UI_EnumerationType_type"),
				 URNModelPackage.Literals.ENUMERATION_TYPE__VALUES,
				 true,
				 false,
				 false,
	...
	protected void addInstancesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumerationType_instances_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumerationType_instances_feature", "_UI_EnumerationType_type"),
				 URNModelPackage.Literals.ENUMERATION_TYPE__INSTANCES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

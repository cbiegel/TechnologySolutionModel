...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 URNModelPackage.Literals.VARIABLE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addEnumerationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_enumerationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_enumerationType_feature", "_UI_Variable_type"),
				 URNModelPackage.Literals.VARIABLE__ENUMERATION_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Variable.class)) {
			case URNModelPackage.VARIABLE__TYPE:
			case URNModelPackage.VARIABLE__ENUMERATION_TYPE:

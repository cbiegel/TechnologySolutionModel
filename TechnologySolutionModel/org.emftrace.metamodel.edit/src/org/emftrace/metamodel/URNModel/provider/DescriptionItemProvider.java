...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.Description} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DescriptionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Description_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Description_description_feature", "_UI_Description_type"),
				 URNModelPackage.Literals.DESCRIPTION__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Description)object).getDescription();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Description.class)) {
			case URNModelPackage.DESCRIPTION__DESCRIPTION:

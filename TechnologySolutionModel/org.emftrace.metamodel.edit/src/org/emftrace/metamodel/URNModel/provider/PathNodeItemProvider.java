...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.PathNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathNodeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathNode_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathNode_label_feature", "_UI_PathNode_type"),
				 URNModelPackage.Literals.PATH_NODE__LABEL,
				 true,
				 false,
				 false,
				 null,
	...
	protected void addPredPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathNode_pred_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathNode_pred_feature", "_UI_PathNode_type"),
				 URNModelPackage.Literals.PATH_NODE__PRED,
				 true,
				 false,
				 false,
	...
	protected void addSuccPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathNode_succ_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathNode_succ_feature", "_UI_PathNode_type"),
				 URNModelPackage.Literals.PATH_NODE__SUCC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addContRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathNode_contRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathNode_contRef_feature", "_UI_PathNode_type"),
				 URNModelPackage.Literals.PATH_NODE__CONT_REF,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathNode_pos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathNode_pos_feature", "_UI_PathNode_type"),
				 URNModelPackage.Literals.PATH_NODE__POS,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(URNModelPackage.Literals.PATH_NODE__LABEL);
			childrenFeatures.add(URNModelPackage.Literals.PATH_NODE__POS);
		}

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.Size} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SizeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 URNModelPackage.Literals.SIZE__WIDTH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 URNModelPackage.Literals.SIZE__HEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Size)object).getWidth();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Size.class)) {
			case URNModelPackage.SIZE__WIDTH:
			case URNModelPackage.SIZE__HEIGHT:

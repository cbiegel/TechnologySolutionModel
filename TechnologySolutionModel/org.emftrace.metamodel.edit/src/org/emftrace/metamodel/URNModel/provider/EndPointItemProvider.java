...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.EndPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EndPointItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOutBindingsPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Out Bindings feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOutBindingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EndPoint_outBindings_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EndPoint_outBindings_feature", "_UI_EndPoint_type"),
				 URNModelPackage.Literals.END_POINT__OUT_BINDINGS,
				 true,
				 false,
				 false,
	...
	protected void addPostconditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EndPoint_postcondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EndPoint_postcondition_feature", "_UI_EndPoint_type"),
				 URNModelPackage.Literals.END_POINT__POSTCONDITION,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(URNModelPackage.Literals.END_POINT__POSTCONDITION);
		}

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.Position} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PositionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 URNModelPackage.Literals.POSITION__X,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 URNModelPackage.Literals.POSITION__Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Position)object).getX();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Position.class)) {
			case URNModelPackage.POSITION__X:
			case URNModelPackage.POSITION__Y:

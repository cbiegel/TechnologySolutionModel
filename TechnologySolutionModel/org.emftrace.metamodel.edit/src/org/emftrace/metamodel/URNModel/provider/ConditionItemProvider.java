...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 URNModelPackage.Literals.CONDITION__EXPRESSION,
				 true,
				 false,
				 false,
	...
	protected void addDescPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_desc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_desc_feature", "_UI_Condition_type"),
				 URNModelPackage.Literals.CONDITION__DESC,
				 true,
				 false,
				 false,
				 null,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_label_feature", "_UI_Condition_type"),
				 URNModelPackage.Literals.CONDITION__LABEL,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(URNModelPackage.Literals.CONDITION__DESC);
			childrenFeatures.add(URNModelPackage.Literals.CONDITION__LABEL);
		}

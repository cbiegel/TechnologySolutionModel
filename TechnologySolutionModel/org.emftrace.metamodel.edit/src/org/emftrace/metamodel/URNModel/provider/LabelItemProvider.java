...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.URNModel.Label} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Label_deltaX_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Label_deltaX_feature", "_UI_Label_type"),
				 URNModelPackage.Literals.LABEL__DELTA_X,
				 true,
				 false,
				 false,
	...
	protected void addDeltaYPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Label_deltaY_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Label_deltaY_feature", "_UI_Label_type"),
				 URNModelPackage.Literals.LABEL__DELTA_Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Label)object).getDeltaX();

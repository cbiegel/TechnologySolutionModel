...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.OWLModel.ObjectProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectProperty_abbreviatedIRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectProperty_abbreviatedIRI_feature", "_UI_ObjectProperty_type"),
				 OWLModelPackage.eINSTANCE.getObjectProperty_AbbreviatedIRI(),
				 true,
				 false,
				 false,
	...
	protected void addIRIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectProperty_IRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectProperty_IRI_feature", "_UI_ObjectProperty_type"),
				 OWLModelPackage.eINSTANCE.getObjectProperty_IRI(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

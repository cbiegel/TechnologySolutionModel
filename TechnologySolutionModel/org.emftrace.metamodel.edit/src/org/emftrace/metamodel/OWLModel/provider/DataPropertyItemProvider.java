...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.OWLModel.DataProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataProperty_abbreviatedIRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataProperty_abbreviatedIRI_feature", "_UI_DataProperty_type"),
				 OWLModelPackage.eINSTANCE.getDataProperty_AbbreviatedIRI(),
				 true,
				 false,
				 false,
	...
	protected void addIRIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataProperty_IRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataProperty_IRI_feature", "_UI_DataProperty_type"),
				 OWLModelPackage.eINSTANCE.getDataProperty_IRI(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

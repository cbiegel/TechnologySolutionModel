...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.OWLModel.Datatype} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Datatype_abbreviatedIRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Datatype_abbreviatedIRI_feature", "_UI_Datatype_type"),
				 OWLModelPackage.eINSTANCE.getDatatype_AbbreviatedIRI(),
				 true,
				 false,
				 false,
	...
	protected void addIRIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Datatype_IRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Datatype_IRI_feature", "_UI_Datatype_type"),
				 OWLModelPackage.eINSTANCE.getDatatype_IRI(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.OWLModel.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_abbreviatedIRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_abbreviatedIRI_feature", "_UI_Class_type"),
				 OWLModelPackage.eINSTANCE.getClass_AbbreviatedIRI(),
				 true,
				 false,
				 false,
	...
	protected void addIRIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_IRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_IRI_feature", "_UI_Class_type"),
				 OWLModelPackage.eINSTANCE.getClass_IRI(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((org.emftrace.metamodel.OWLModel.Class)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(org.emftrace.metamodel.OWLModel.Class.class)) {

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.OWLModel.Prefix} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrefixItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Prefix_IRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Prefix_IRI_feature", "_UI_Prefix_type"),
				 OWLModelPackage.eINSTANCE.getPrefix_IRI(),
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Prefix_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Prefix_name_feature", "_UI_Prefix_type"),
				 OWLModelPackage.eINSTANCE.getPrefix_Name(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Prefix)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Prefix_type") :
			getString("_UI_Prefix_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.EMFfitModel.FactorTable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FactorTableItemProvider
	 ...
	 * @generated
	 */
	public FactorTableItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FactorTable_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FactorTable_type_feature", "_UI_FactorTable_type"),
				 EMFfitModelPackage.Literals.FACTOR_TABLE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addEntriesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FactorTable_entries_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FactorTable_entries_feature", "_UI_FactorTable_type"),
				 EMFfitModelPackage.Literals.FACTOR_TABLE__ENTRIES,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EMFfitModelPackage.Literals.FACTOR_TABLE__ENTRIES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FactorTable"));
	}

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.BPMN2Model.ThrowEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThrowEventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ThrowEvent_dataInputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ThrowEvent_dataInputs_feature", "_UI_ThrowEvent_type"),
				 BPMN2ModelPackage.eINSTANCE.getThrowEvent_DataInputs(),
				 true,
				 false,
				 false,
				 null,
	...
	protected void addDataInputAssociationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ThrowEvent_dataInputAssociation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ThrowEvent_dataInputAssociation_feature", "_UI_ThrowEvent_type"),
				 BPMN2ModelPackage.eINSTANCE.getThrowEvent_DataInputAssociation(),
				 true,
				 false,
				 false,
				 null,
	...
	protected void addInputSetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ThrowEvent_inputSet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ThrowEvent_inputSet_feature", "_UI_ThrowEvent_type"),
				 BPMN2ModelPackage.eINSTANCE.getThrowEvent_InputSet(),
				 true,
				 false,
				 false,
				 null,
	...
	protected void addEventDefinitionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ThrowEvent_eventDefinitions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ThrowEvent_eventDefinitions_feature", "_UI_ThrowEvent_type"),
				 BPMN2ModelPackage.eINSTANCE.getThrowEvent_EventDefinitions(),
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getThrowEvent_EventDefinitionRefs(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN2ModelPackage.eINSTANCE.getThrowEvent_DataInputs());
			childrenFeatures.add(BPMN2ModelPackage.eINSTANCE.getThrowEvent_DataInputAssociation());
			childrenFeatures.add(BPMN2ModelPackage.eINSTANCE.getThrowEvent_InputSet());
		}

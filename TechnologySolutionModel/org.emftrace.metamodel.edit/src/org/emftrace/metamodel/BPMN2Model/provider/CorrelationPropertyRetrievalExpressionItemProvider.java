...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.BPMN2Model.CorrelationPropertyRetrievalExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CorrelationPropertyRetrievalExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getCorrelationPropertyRetrievalExpression_MessagePath(),
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getCorrelationPropertyRetrievalExpression_MessageRef(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN2ModelPackage.eINSTANCE.getCorrelationPropertyRetrievalExpression_MessagePath());
		}

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.BPMN2Model.SubChoreography} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addArtifactsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubChoreography_artifacts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubChoreography_artifacts_feature", "_UI_SubChoreography_type"),
				 BPMN2ModelPackage.eINSTANCE.getSubChoreography_Artifacts(),
				 true,
				 false,
				 false,
				 null,

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.BPMN2Model.CorrelationSubscription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CorrelationSubscriptionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CorrelationSubscription_correlationPropertyBinding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CorrelationSubscription_correlationPropertyBinding_feature", "_UI_CorrelationSubscription_type"),
				 BPMN2ModelPackage.eINSTANCE.getCorrelationSubscription_CorrelationPropertyBinding(),
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getCorrelationSubscription_CorrelationKeyRef(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN2ModelPackage.eINSTANCE.getCorrelationSubscription_CorrelationPropertyBinding());
		}

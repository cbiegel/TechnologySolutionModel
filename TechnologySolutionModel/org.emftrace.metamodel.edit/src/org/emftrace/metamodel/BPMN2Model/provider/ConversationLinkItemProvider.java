...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.BPMN2Model.ConversationLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getConversationLink_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getConversationLink_SourceRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getConversationLink_TargetRef(),
				 true,
				 false,
				 true,
				 null,

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.BPMN2Model.ParticipantAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getParticipantAssociation_InnerParticipantRef(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getParticipantAssociation_OuterParticipantRef(),
				 true,
				 false,
				 true,
				 null,

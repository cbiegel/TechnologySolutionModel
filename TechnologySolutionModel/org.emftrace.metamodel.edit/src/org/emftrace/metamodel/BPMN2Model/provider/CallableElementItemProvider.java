...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.BPMN2Model.CallableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallableElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getCallableElement_SupportedInterfaceRefs(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIoSpecificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CallableElement_ioSpecification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CallableElement_ioSpecification_feature", "_UI_CallableElement_type"),
				 BPMN2ModelPackage.eINSTANCE.getCallableElement_IoSpecification(),
				 true,
				 false,
				 false,
				 null,
	...
	protected void addIoBindingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CallableElement_ioBinding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CallableElement_ioBinding_feature", "_UI_CallableElement_type"),
				 BPMN2ModelPackage.eINSTANCE.getCallableElement_IoBinding(),
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getCallableElement_Name(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN2ModelPackage.eINSTANCE.getCallableElement_IoSpecification());
			childrenFeatures.add(BPMN2ModelPackage.eINSTANCE.getCallableElement_IoBinding());
		}

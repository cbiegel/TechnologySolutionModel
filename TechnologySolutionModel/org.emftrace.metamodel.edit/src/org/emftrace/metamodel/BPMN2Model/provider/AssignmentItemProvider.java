...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.BPMN2Model.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getAssignment_From(),
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BPMN2ModelPackage.eINSTANCE.getAssignment_To(),
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMN2ModelPackage.eINSTANCE.getAssignment_From());
			childrenFeatures.add(BPMN2ModelPackage.eINSTANCE.getAssignment_To());
		}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == BPMN2ModelPackage.eINSTANCE.getAssignment_From() ||
			childFeature == BPMN2ModelPackage.eINSTANCE.getAssignment_To();

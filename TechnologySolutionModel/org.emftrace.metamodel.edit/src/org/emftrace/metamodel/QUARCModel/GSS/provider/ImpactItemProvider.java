...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.QUARCModel.GSS.Impact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImpactItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Impact_weight_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Impact_weight_feature", "_UI_Impact_type"),
				 GSSPackage.Literals.IMPACT__WEIGHT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Impact)object).getWeight();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Impact.class)) {
			case GSSPackage.IMPACT__WEIGHT:

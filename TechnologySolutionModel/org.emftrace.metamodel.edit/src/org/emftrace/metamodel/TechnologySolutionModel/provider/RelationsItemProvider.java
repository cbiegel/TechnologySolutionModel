...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.TechnologySolutionModel.Relations} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationsItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relations_Relations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relations_Relations_feature", "_UI_Relations_type"),
				 TechnologySolutionModelPackage.Literals.RELATIONS__RELATIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TechnologySolutionModelPackage.Literals.RELATIONS__RELATIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Relations.class)) {
			case TechnologySolutionModelPackage.RELATIONS__RELATIONS:

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.TechnologySolutionModel.TechnologyFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TechnologyFeatureItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TechnologySolutionModelPackage.Literals.TECHNOLOGY_FEATURE__DESCRIPTION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TechnologySolutionModelPackage.Literals.TECHNOLOGY_FEATURE__CAPABILITY_TYPE,
				 true,
				 false,
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TechnologySolutionModelPackage.Literals.TECHNOLOGY_FEATURE__ASTA,
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TechnologySolutionModelPackage.Literals.TECHNOLOGY_FEATURE__RELATIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFeatureEvaluationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TechnologyFeature_FeatureEvaluation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TechnologyFeature_FeatureEvaluation_feature", "_UI_TechnologyFeature_type"),
				 TechnologySolutionModelPackage.Literals.TECHNOLOGY_FEATURE__FEATURE_EVALUATION,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TechnologySolutionModelPackage.Literals.TECHNOLOGY_FEATURE__ASTA);
			childrenFeatures.add(TechnologySolutionModelPackage.Literals.TECHNOLOGY_FEATURE__FEATURE_EVALUATION);
		}

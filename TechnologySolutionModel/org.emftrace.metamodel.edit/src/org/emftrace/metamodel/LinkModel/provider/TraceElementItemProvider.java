...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.LinkModel.TraceElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LinkModelPackage.Literals.TRACE_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCreatedByUserPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TraceElement_CreatedByUser_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TraceElement_CreatedByUser_feature", "_UI_TraceElement_type"),
				 LinkModelPackage.Literals.TRACE_ELEMENT__CREATED_BY_USER,
				 true,
				 false,
				 false,

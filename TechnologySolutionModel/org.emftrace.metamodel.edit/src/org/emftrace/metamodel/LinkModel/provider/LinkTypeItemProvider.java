...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.LinkModel.LinkType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkType_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkType_Name_feature", "_UI_LinkType_type"),
				 LinkModelPackage.Literals.LINK_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRefinementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkType_Refinement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkType_Refinement_feature", "_UI_LinkType_type"),
				 LinkModelPackage.Literals.LINK_TYPE__REFINEMENT,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LinkModelPackage.Literals.LINK_TYPE__REFINEMENT);
		}

...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.FeatureModel.Constant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstantItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constant_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constant_content_feature", "_UI_Constant_type"),
				 FeatureModelPackage.Literals.CONSTANT__CONTENT,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Constant.class)) {
			case FeatureModelPackage.CONSTANT__CONTENT:

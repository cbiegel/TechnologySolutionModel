...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.FeatureModel.Properties} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertiesItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Properties_property_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Properties_property_feature", "_UI_Properties_type"),
				 FeatureModelPackage.Literals.PROPERTIES__PROPERTY,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FeatureModelPackage.Literals.PROPERTIES__PROPERTY);
		}
	...
	public String getText(Object object) {
		String label = ((Properties)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Properties.class)) {
			case FeatureModelPackage.PROPERTIES__PROPERTY:

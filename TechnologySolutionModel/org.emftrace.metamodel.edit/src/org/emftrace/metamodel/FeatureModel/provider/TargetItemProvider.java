...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.FeatureModel.Target} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TargetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Target_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Target_content_feature", "_UI_Target_type"),
				 FeatureModelPackage.Literals.TARGET__CONTENT,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Target.class)) {
			case FeatureModelPackage.TARGET__CONTENT:
